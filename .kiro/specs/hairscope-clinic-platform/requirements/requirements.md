...
| `catalog` | Clinical | Includes services (for appointments) and products (medications, cosmetics, supplements). Also includes treatment kits. |
| `billing` | Clinical | |
...
| All other data (catalog items, treatment kits, routines) | Indefinite | 2 years after subscription cancellation, then deleted | No |
...
| Notification Service | `core/notification-engine.md` |
| Reminder Service | `core/reminder-engine.md` |
...
| Communication Policy | `modules/communication-policy.md` |
| Selfie Analysis Web Component | `web-components/selfie-analysis.md` |
| Appointment Booking Web Component | `web-components/appointment-booking.md` |
